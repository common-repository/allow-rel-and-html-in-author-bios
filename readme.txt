...
Donate link: 
Tags: rel, HTML, bio, description, author, user
Requires at least: 2.0.2
Tested up to: 3.2
Stable tag: 1.0
Enables use of REL= or anything else in Author bio area (for Google+ search results). WARNING: CAN BE USED FOR EVIL! Make sure you trust authors!
...
== Upgrade Notice ==
No upgrades available or required.
